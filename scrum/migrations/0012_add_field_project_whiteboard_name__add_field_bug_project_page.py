...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.whiteboard_name'
        db.add_column('scrum_project', 'whiteboard_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Project.wiki_page'
        db.add_column('scrum_project', 'wiki_page',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.whiteboard_name'
        db.delete_column('scrum_project', 'whiteboard_name')

        # Deleting field 'Project.wiki_page'
        db.delete_column('scrum_project', 'wiki_page')
    ...
    models = {
        ...
        'scrum.project': {
            ...
            'whiteboard_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'wiki_page': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'})
        },
        'scrum.sprint': {
